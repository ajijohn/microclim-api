...
class MicroclimApiClient(HttpApiClient):
    ...
    def get_details(self, requestId=None):
        ...
        Returns:
          Details of the filtering job (includes the files generated by the request)
    ...
    def get_file(self, requestId=None,fileKey=None):
        """
        Downloads the artifact of the request -
        ...
        params = self._get_params(requestId=requestId,fileKey=fileKey)

        return self._create_query('microclim/download', params)
    ...
    def poke(self, active=None):
        ...
        return self._create_query('microclim/poke', params)
